...
registry.decl(MergedBundleNodeName, BundleNodeName, /** @lends MergedBundleNode.prototype */ {
    ...
    /**
     * Returns an array of the tech names which should be merged. This merged bundle
     ...
     * when this method returns undefined value.
     */
    ...
    _createMergedTechNode: function(tech, bundleNode, magicNode) {
        var ctx = this.ctx,
            ...
            bundles = (this.getMergeBundles() || arch.getChildren(levelNode))
                .filter(function(b) {
